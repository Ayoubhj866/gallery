    ...
    <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1
                ...
                Crafting Experiences <br> & Memorable Brands.</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                Your Source for Stunning Images - Discover a World of Visual Inspiration with Our Free and Open-Source
                Template, Crafted with Tailwind CSS and Enhanced by the Flowbite Library and Blocks System</a>.
            </p>
            <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <a href="https://github.com/Ayoubhj866/gallery"
